const citations = [
    ...
    "Si tu n'es pas heureux seul, tu ne seras pas heureux à deux.... Le bonheur provient de l'intérieur,pas des autres!",
    ...
    "Aujourd'hui je suis aussi efficace qu'un doigt d'honneur dans une moufle!",
